...
public enum EffectMapping {
    ...
    FEATHER  ("feather",   3, new Color(0xBEA3CA), BossBar.Color.WHITE,  Feather::applyPassiveEffects,      Feather::activateSpark),
    ...
    REGEN    ("regen",    10, new Color(0xFF5555), BossBar.Color.PINK,   Regen::applyPassiveEffects,        Regen::activateSpark),
    SPEED    ("speed",    11, new Color(0xEEBB77), BossBar.Color.YELLOW, Speed::applyPassiveEffects,        Speed::activateSpark),
    STRENGTH ("strength", 12, new Color(0x800000), BossBar.Color.RED,    Strength::applyPassiveEffects,     Strength::activateSpark),
    THUNDER  ("thunder",  13, Color.YELLOW,        BossBar.Color.YELLOW, Thunder::applyPassiveEffects,      Thunder::activateSpark),
