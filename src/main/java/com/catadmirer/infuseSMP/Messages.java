...
public enum Messages {
    ...
    REGEN_LORE("regen.effect_lore", "<#D9148E><b>ᴘᴀꜱꜱɪᴠᴇ ᴇꜰꜰᴇᴄᴛꜱ:", "<#D9148E>\ud83d\ude91 <dark_gray>Every hit grants Regeneration 2 for 1 second", "<#D9148E>\ud83d\ude91 <dark_gray>Healing gives 3 extra saturation bars", "<dark_gray>", "<#D9148E>ꜱᴘᴀʀᴋ ᴇꜰꜰᴇᴄᴛ:", "<#D9148E>\ud83d\ude91 <dark_gray>Apply lifesteal effect that heals you based on your damage dealt", "<dark_gray>", "<dark_aqua>ᴅᴜʀᴀᴛɪᴏɴ: 30s", "<dark_aqua>ᴄᴏᴏʟᴅᴏᴡɴ: 60s"),
