...
public enum Messages {
    ...
    INFUSE_GIVEEFFECT_USAGE("infuse_giveeffect.usage", "<red>Invalid Argument! Please use /infuse giveEffect <player> <aug_fire|ocean>"),
    INFUSE_GIVEEFFECT_SUCCESS("infuse_giveeffect.success", "%effect_color%You recieved the %effect_name%"),
    ...
    OCEAN_LORE("ocean.effect_lore", "<blue><b>ᴘᴀꜱꜱɪᴠᴇ ᴇꜰꜰᴇᴄᴛꜱ:", "<blue>🫧 <dark_gray>Swim faster", "<blue>🫧 <dark_gray>Breathe underwater", "<blue>🫧 <dark_gray>Make everyone around you start drowning when in water", "<blue>🫧 <dark_gray>Tridents pull players", "<dark_gray>", "<blue><b>ꜱᴘᴀʀᴋ ᴇꜰꜰᴇᴄᴛꜱ:", "<blue>🫧 <dark_gray>Creates a Whirlhole", "<dark_gray>", "<dark_aqua>ᴅᴜʀᴀᴛɪᴏɴ: 15s", "<dark_aqua>ᴄᴏᴏʟᴅᴏᴡɴ: 60s"),
    AUG_OCEAN_NAME("aug_ocean.effect_name", "<blue>Augmented Ocean Effect"),
    AUG_OCEAN_LORE("aug_ocean.effect_lore", "<blue><b>ᴘᴀꜱꜱɪᴠᴇ ᴇꜰꜰᴇᴄᴛꜱ:", "<blue>🫧 <dark_gray>Swim faster", "<blue>🫧 <dark_gray>Breathe underwater", "<blue>🫧 <dark_gray>Make everyone around you start drowning when in water", "<blue>🫧 <dark_gray>Tridents pull players", "<dark_gray>", "<blue><b>ꜱᴘᴀʀᴋ ᴇꜰꜰᴇᴄᴛꜱ:", "<blue>🫧 <dark_gray>Creates a Whirlhole", "<dark_gray>", "<dark_aqua>ᴅᴜʀᴀᴛɪᴏɴ: 15s", "<dark_aqua>ᴄᴏᴏʟᴅᴏᴡɴ: 30s"),
    
    REGEN_NAME("regen.effect_name", "<#D9148E>Regeneration Effect"),
    REGEN_LORE("regen.effect_lore", "<#D9148E><b>ᴘᴀꜱꜱɪᴠᴇ ᴇꜰꜰᴇᴄᴛꜱ:", "<#D9148E>\ud83d\ude91 <dark_gray>Every hit grants Regeneration 2 for 1 second", "<#D9148E>\ud83d\ude91 <dark_gray>Healing gives 3 extra saturation bars", "<dark_gray>", "<#D9148E>ꜱᴘᴀʀᴋ ᴇꜰꜰᴇᴄᴛꜱ:", "<#D9148E>\ud83d\ude91 <dark_gray>Apply lifesteal effect that heals you based on your damage dealt", "<dark_gray>", "<dark_aqua>ᴅᴜʀᴀᴛɪᴏɴ: 30s", "<dark_aqua>ᴄᴏᴏʟᴅᴏᴡɴ: 60s"),
    AUG_REGEN_NAME("aug_regen.effect_name", "<#D9148E>Augmented Regeneration Effect"),
    AUG_REGEN_LORE("aug_regen.effect_lore", "<#D9148E><b>ᴘᴀꜱꜱɪᴠᴇ ᴇꜰꜰᴇᴄᴛꜱ:", "<#D9148E>\ud83d\ude91 <dark_gray>Every hit grants Regeneration 2 for 1 second", "<#D9148E>\ud83d\ude91 <dark_gray>Healing gives 3 extra saturation bars", "<dark_gray>", "<#D9148E>ꜱᴘᴀʀᴋ ᴇꜰꜰᴇᴄᴛꜱ:", "<#D9148E>\ud83d\ude91 <dark_gray>Apply lifesteal effect that heals you based on your damage dealt", "<dark_gray>", "<dark_aqua>ᴅᴜʀᴀᴛɪᴏɴ: 30s", "<dark_aqua>ᴄᴏᴏʟᴅᴏᴡɴ: 30s"),
